...
import com.application.services.partn.databinding.WebFragmentBinding
...
class WebViewFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val vmFactory = EgyptSunVMFactory(requireActivity().application)
        myVM = ViewModelProvider(this, vmFactory)[EgyptSunVM::class.java]
            ...
            when (url) {
                BASE_URL -> {
                    ...
                    lifecycleScope.launch(Dispatchers.IO) {
                        if (myVM.checkDatastoreValue(SHARED_PREF_NAME, requireContext())
                                .isNullOrEmpty()
                        ) {
    ...
    companion object {
        ...
        const val BASE_URL = "https://egyptsun.store/"
